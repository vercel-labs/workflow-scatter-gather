...
export const metadata: Metadata = {
  title: "Scatter-Gather — Workflow DevKit Example",
  description:
    "Demonstrates parallel scatter-gather: fan out price quotes to multiple providers, then gather and pick the best result.",
};
